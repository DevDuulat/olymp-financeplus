<footer class="bg-gray-800 font-sans tracking-wide">
    <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8 px-10 py-8">
        <div>
            <h4 class="text-lg font-semibold mb-6 text-white">О нас</h4>
        ...
        <div>
            <h4 class="text-lg font-semibold mb-6 text-white">Услуги</h4>
            <ul class="space-y-4">
                <li><a href="javascript:void(0)" class="text-gray-400 hover:text-white text-base">Услуга 1</a></li>
                <li><a href="javascript:void(0)" class="text-gray-400 hover:text-white text-base">Услуга 2</a>
                </li>
                <li><a href="javascript:void(0)" class="text-gray-400 hover:text-white text-base">Услуга 3</a></li>
                <li><a href="javascript:void(0)" class="text-gray-400 hover:text-white text-base">Услуга 4</a></li>
            </ul>
        </div>

        <div class="space-y-4">
            <h4 class="text-lg font-semibold mb-6 text-white">Контакты</h4>
            <p class="text-gray-400 text-base">Район Улица</p>
            <p class="text-gray-400 text-base">Страна Город </p>
            <p class="text-gray-400 text-base">contact@example.com</p>
            <p class="text-gray-400 text-base">+996 11 22 11</p>
        </div>

        <div>
            <h4 class="text-lg font-semibold mb-6 text-white">Подпишитесь на нас</h4>
    ...
    <div class="bg-gray-900 p-5 mt-12">
        <p class='text-gray-400 text-base text-center'>Copyright © 2024<a href='' target='_blank'
                                                                          class="hover:underline mx-1">OlympFinance</a>All Rights Reserved.</p>
    </div>
</footer>
